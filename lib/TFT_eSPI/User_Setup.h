...
#define TFT_MISO  PIN_MISO  // Automatically assigned with ESP8266 if not defined
#define TFT_MOSI  PIN_MOSI  // Automatically assigned with ESP8266 if not defined
